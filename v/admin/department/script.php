...
//        jQuery('#modal_profile').modal('show', {backdrop: 'true'});
        $.get("http://localhost/pr-timetable/department/add", {headless: true}, function (resp) {
//            jQuery('#modal_profile .modal-body').html(resp);
            popShiiUp("Add Department", resp);
        });
    }

    function edit_department(department_id) {
//        jQuery('#modal_profile').modal('show', {backdrop: 'true'});
        $.get("http://localhost/pr-timetable/department/edit/" + department_id, {headless: true}, function (resp) {
//            jQuery('#modal_profile .modal-body').html(resp);
            popShiiUp("Edit Department", resp);
        });
    }
