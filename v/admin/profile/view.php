...
$admin_id = myid();
//print_r($student_id);
$profile_data = get_admin_info($admin_id);
foreach ($profile_data as $row) {
    ...
    <div class="panel">
        <div class="panel-bg-cover" id="profile_banner">
            <img class="img-responsive " src="<?php echo get_image_url('admin', $row['id']); ?>" alt="Image">
        </div>
        <div class="panel-media">
            <img src="<?php echo get_image_url('admin', $row['id']); ?>" class="panel-media-img img-circle img-border-light" alt="Profile Picture">

            <div class="row" >
                <div class="col-lg-7">
                    <h4 class="panel-media-heading"><?php echo $row['username']; ?></h4>
                    <a href="#" class="btn-link">@<?php echo $this->admin; ?></a>
                ...
                <div class="col-lg-5 text-lg-right">
                    <a href="<?php echo URL . "student/edit/" . $this->student ?>" class="btn btn-sm btn-primary">Edit Profile</a> 
                </div>
            </div>
