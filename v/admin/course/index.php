    ...
    <div class="panel-heading">
        <div class="panel-control">
            <ul class="pager pager-rounded">
                <li>
                    <a onclick="add_course()" ><i class="fa fa-plus"></i> Add Course</a>
                </li>
            </ul>
        </div>
                ...
                <tbody>
                    ...
                    foreach ($courses as $row) {
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <div class="btn-group">
                                    <!-- <button class="btn btn-white" onclick="edit_course('<?php echo $row['id']; ?>');" type="button">Edit</button> &nbsp -->
                                    <button class="btn btn-danger" onclick="delete_course('<?php echo $row['id']; ?>');" type="button">Delete</button>
                                </div>
                            </td>
                            <?php $count++; ?>
                        </tr>
...
<script type="text/javascript">
        ...
        function delete_course(username) {
            alertify.confirm("Delete Course", "Do You Really Want To Delete? ", function () {
                $.post("http://localhost/pr-timetable/courses/delete/", {who: username}, function (resp) {
    //                jQuery('#modal_profile .modal-body').html(resp);
                    window.location = "http://localhost/pr-timetable/courses/";
                });
            }, function () {
