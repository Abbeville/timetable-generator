...
//        jQuery('#modal_profile').modal('show', {backdrop: 'true'});
        $.get("http://localhost/pr-timetable/courses/add", {headless: true}, function (resp) {
//            jQuery('#modal_profile .modal-body').html(resp);
            popShiiUp("Add Course", resp);
        });
    }

    function edit_course(course_id) {
//        jQuery('#modal_profile').modal('show', {backdrop: 'true'});
        $.get("http://localhost/pr-timetable/courses/edit/" + course_id, {headless: true}, function (resp) {
//            jQuery('#modal_profile .modal-body').html(resp);
            popShiiUp("Edit Course", resp);
        });
    }
