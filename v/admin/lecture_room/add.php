            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel " data-collapsed="0">
                        ...
                        <div class="panel-body">
                            <form action="<?php echo URL; ?>lecture_room/addRoom" method="post" 
...
<!--                    <input type="hidden" name="action" value="ekattor_form_submit">
                    <input type="hidden" name="task" value="add_class">-->
                                ...
                                <div class="form-group">
                                    <label for="field-1" class="col-sm-3 control-label">Capacity</label>

                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" name="capacity" data-validate="required" 
                                               data-message-required="value required">
                                    </div>
                                </div>
