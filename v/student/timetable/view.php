...
<div class="panel ">
    <div class="panel-heading">
        <h3 class="panel-title">View Time Table</h3>
    </div>
                        ...
                        <tbody id="setTimetable">
                          ...
                          <tr>
                            <td><?php echo $periods[$i - 1]['time']; ?></td>
                                ...
                                ?>
                            <td>
                                <?php echo getStudentTimeTable($class_id, $i, $j) == null ? 'Free Period' : strtoupper(get_coursename_from_id(getStudentTimeTable($class_id,$i, $j)['course_id'])).'<br><b>'.strtoupper(get_lecturername_from_id(getStudentTimeTable($class_id,$i, $j)['lecturer_id'])); ?>
                            </td>
                                <?php
                                    $j = $j + 1;
                                    $lecture_counter++;
