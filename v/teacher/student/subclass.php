<?php
//@session_start();
//$h = Session::get("david0000");
$suv = $this->class;
if (isset($this->classiddd)) {
    $class_id = $this->classiddd;
}
$students = get_students_in_subclas($suv);
//print_r($h)  ;  
?>
<style>
    .ffff {
...
<div class="tab-base">
    ...
    <ul class="nav nav-tabs">
        <li class="active">
            <a aria-expanded="true" href="#demo-search-tab-2" data-toggle="tab"> <?php echo get_class_name_from_id($class_id); ?>: <?php echo get_Sub_class_name_from_id($suv); ?>   <span class="badge badge-primary"><?php echo count($students); ?></span></a>
        </li>
